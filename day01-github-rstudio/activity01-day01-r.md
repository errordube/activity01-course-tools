...
``` r
# Item 2
# Printing the range of number from 1 to 9 and assigning it to the variable int_vect
int_vect <- 1:9
int_vect
```
...
``` r
# Item 3
# Printing alphabets from A to Q using LETTERS function and assigning it to the char_vect variable
...
``` r
# Item 4
# This returns the count the number of items after D letter, 
